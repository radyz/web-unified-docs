...
For a Vault Enterprise deployment, pass the license secret at install time — the chart will automatically use the enterprise-compatible injector image:
